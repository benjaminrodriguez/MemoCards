...
<a class="navbar-brand" href="index.php?page=accueil"><img src="./vues/img/logo.png" width="70" height="55" border="0" /></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="index.php?page=accueil"><b><h3>Accueil</h3></b><span class="sr-only">(current)</span></a>
    </li>

    <li class="nav-item active">
      <a class="nav-link" href="index.php?page=profil"><b><h3>Mon Profil</h3></b></a>
    </li>
    ...
    <li class="nav-item active">
      <a class="nav-link" href="index.php?page=inventaire"><b><h3>Mon Inventaire</h3></b></a>
    </li>
