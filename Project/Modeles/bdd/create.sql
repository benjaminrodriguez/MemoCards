...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 28 nov. 2018 à 12:56
...
--
-- Structure de la table `message_has_subject`
--

DROP TABLE IF EXISTS `message_has_subject`;
CREATE TABLE IF NOT EXISTS `message_has_subject` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `subject_id` int(11) NOT NULL,
  `message_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_message_has_subject_subject1_idx` (`subject_id`),
  KEY `fk_message_has_subject_message1_idx` (`message_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `passed` (
  ...
  `number_game` int(11) NOT NULL,
  `score_user` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `deck_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Contraintes pour la table `message_has_subject`
--
ALTER TABLE `message_has_subject`
  ADD CONSTRAINT `fk_message_has_subject_message1` FOREIGN KEY (`message_id`) REFERENCES `message` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_message_has_subject_subject1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
