    ...
    <div class="row"><!--Container row-->
        ...
        <div class="span3 sidebar page-right-sidebar"><!-- Begin sidebar column -->
            ...
            <div class="input-prepend">
                <span class="add-on"><i class="icon-user"></i></span><input class="span2" id="prependedInput" size="16" type="text" placeholder="Pseudo">
            </div>
            <div class="input-prepend">
                <span class="add-on"><i class="icon-lock"></i></span><input class="span2" id="appendedPrependedInput" size="16" type="text" placeholder="Mot de passe">
            </div>
